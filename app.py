...
# ==========================================
# 📘 頁面：📘作業規範SOP",(按鈕填滿藍色 + 文字全面加大並改為橙色清晰版)
# ==========================================
    elif st.session_state.menu_selection == "📘作業規範SOP":
        import base64
        import re
        ...
        # 頂部大標題 (放大且改為橙色)
        st.markdown('<h1 style="text-align:center; color:#ea580c; font-weight:900; font-size:2.8rem;">📘作業規範SOP 線上查閱中心</h1>', unsafe_allow_html=True)
